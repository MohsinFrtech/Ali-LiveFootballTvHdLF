...
class TeamMatchesList extends StatefulWidget {
  const TeamMatchesList({super.key});
      ...
      body: Stack(
        children: [
          Column(
            children: [
              ...
              Expanded(
                child: Obx(
                  () => Visibility(
                    visible: footballController!.showTeamMatches.value,
                    child: ListView.builder(
                      padding: EdgeInsets.only(top: 10.0),
                      itemBuilder: (BuildContext context, int index) {
                        SortedFootballClass match =
                            footballController!.teamMatches[index];
                        return Padding(
                      ...
                      itemCount: footballController!.teamMatches.length,
                      shrinkWrap: true,
          ...
          Obx(
            () => Center(
              child: Visibility(
                visible: footballController!.teamMatchProgress.value,
